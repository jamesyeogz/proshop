...
export const USER__PROFILE_REQUEST = 'USER__PROFILE_REQUEST'
export const  USER__PROFILE_SUCCESS = 'USER__PROFILE_SUCCESS'
export const  USER__PROFILE_FAIL = 'USER__PROFILE_FAIL'
export const  USER__PROFILE_RESET = 'USER__PROFILE_RESET'
